...
public class SimpleAsyncTask extends AsyncTask<Void,Void, String> {
    ...
    SimpleAsyncTask(TextView tv, TextView barra, Context context) {
    ...
    protected String doInBackground(Void... voids) {
        ...
        return "Estuve ausente por:  " + s + " Milisegundos...";
    }
    ...
    protected void onPostExecute(String result) {
        ...
        barra.setBackgroundColor(context.getResources().getColor(R.color.verde));
